...
const options = {
  definition: {
    ...
    info: {
      ...
      version: '1.0.0',
      description: 'An Express-based REST API that fetches and pushes airq quality data to a Google Cloud SQL instance',
    },
    servers: [
      {
        url: '/api/v1',
  ...
  apis: ['./Controllers/Mappings.js', './Routes/Router.js'], // Path to the API docs
};
